...
const NavBar = () => {
  ...
  return (
    <>
      <nav className="bg-white border-gray-200 dark:bg-gray-900 hidden md:flex md:px-6 sticky top-0">
        <div className="w-full max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Perawat Komputer</span>
          </a>
          ...
          {/* Navbar Links */}
          <div className={`items-center justify-between ${isDropdownOpen ? "flex" : "hidden"} w-full xl:flex xl:w-auto xl:order-1`} id="navbar-language">
